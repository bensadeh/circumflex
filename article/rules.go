...
func filterSite(text string, url string) string {
	...
	case strings.Contains(url, "en.wikipedia.org"):
		...
		rs.endBeforeLineEquals(sectionMarker + " References")
		rs.endBeforeLineEquals(sectionMarker + " Footnotes")
		rs.endBeforeLineEquals(sectionMarker + " See also")
		rs.endBeforeLineEquals(sectionMarker + " Notes")
